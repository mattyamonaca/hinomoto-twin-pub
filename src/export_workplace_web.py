...
def main():
    ...
    g['workplace']={'version':str(d['model_version']),'stage':'C','index':'workplace/index.json','index_sha256':sha(ib),'files':len(index),'industry_codes':d['industry_codes'].tolist(),'categories':d['categories'].tolist(),
