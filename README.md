...
![港区・35〜39歳・男性の年収500〜600万円。割合11.666%、計算対象11,202人、推定人数1,307人](docs/images/guide/04-income.jpg)
...
![年収推定の作り方。計算の流れから各工程の説明を開く](docs/images/guide/05-method.jpg)
...
![独自仮定の説明。分かっていること、未確認の範囲、検証方法を確認する](docs/images/guide/06-assumption.jpg)
...
<img src="docs/images/guide/01-start.jpg" alt="スマートフォン幅の初期画面。条件は上部、説明の開くボタンは下部にある" width="320">
