...
## 可視化サイトの使い方（スクリーンショット付き）

**[Hinomoto Twin Explorer を開く](https://mattyamonaca.github.io/hinomoto-twin-pub/)**。閲覧にログインやPythonのインストールは不要です。
...
![PCの初期画面。左に条件一覧、中央に条件を展開する領域、右に説明パネル](docs/images/guide/01-desktop.jpg)
