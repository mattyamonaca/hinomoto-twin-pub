...
![PCの初期画面。左に条件一覧、中央に条件を展開する領域、右に説明パネル](docs/images/guide/01-desktop.png)
...
![「港区」の検索結果。東京都港区・名古屋市港区・大阪市港区を区別して選ぶ](docs/images/guide/02-search.png)
...
![港区の年齢構成で35〜39歳を選択した画面](docs/images/guide/03-age.png)
...
![港区・35〜39歳・男性の年収500〜600万円。割合11.666%、計算対象11,202人、推定人数1,307人](docs/images/guide/04-income.png)
...
![年収推定の作り方。計算の流れから各工程の説明を開く](docs/images/guide/05-method.png)
...
![独自仮定の説明。分かっていること、未確認の範囲、検証方法を確認する](docs/images/guide/06-assumption.png)
...
<img src="docs/images/guide/01-start.png" alt="スマートフォン幅の初期画面。条件は上部、説明の開くボタンは下部にある" width="320">
